...
*Disclaimer: This template is heavily inspired by the great [RFC template](https://github.com/yarnpkg/rfcs/blob/master/0000-template.md) that Yarn has come up with. (You may remove this disclaimer).*
## Summary
